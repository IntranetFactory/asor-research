...
## [2026-04-12] ingest | HRIS, HRMS, HCM, and Global Payroll Operating Models
- Source: sources/how do HRIS vs. HRMS vs. HCM compare _ which features do they usually provide_.md -> raw/hr-operations/hris-vs-hrms-vs-hcm-comparison-and-global-payroll.md
- Updated: Airtable for HR Workflow Management

## [2026-04-12] ingest | AI Agent Governance Platforms Landscape
- Source: sources/What are the stand-alone AI Agent Governance or AI Workforce Management platforms that can act as a vendor-neutral 'HR system' for agents built on different platforms similar to workday asor_ it must focus on _h.md → raw/hr-operations/ai-agent-governance-platforms-landscape-qa.md
- Updated: Agent System of Record for Blended Workforces

## [2026-04-12] ingest | Agent System of Record for Blended Workforces (Q&A merge)
- Source: sources/what is Workday's Agent System of Record (ASoR).md → raw/hr-operations/workday-asor-overview-qa.md
- Updated: Agent System of Record for Blended Workforces

## [2026-04-12] ingest | ASOR Agent Definition API
- Source: https://github.com/Workday/asor -> raw/hr-operations/2026-04-12-workday-asor-github-api-spec.md
- Updated: Agent System of Record for Blended Workforces

## [2026-04-12] ingest | Agent System of Record for Blended Workforces (GA)
- Source: https://blog.workday.com/en-us/managing-ai-powered-future-of-work.html -> raw/hr-operations/2026-04-12-managing-ai-powered-future-of-work.md
- Updated: Agent System of Record for Blended Workforces

## [2026-04-12] ingest | Agent System of Record for Blended Workforces
